...
$menuGroups = [
    [
        ...
        'items' => [
            ...
            ['label' => 'Item Classifications', 'path' => 'modules/classifications/index.php', 'needle' => '/classifications/', 'icon' => 'bi bi-tags'],
    ...
    [
        ...
        'items' => [
            ...
            ['label' => 'Transfer of Accountability', 'path' => 'modules/transfers/index.php', 'needle' => '/transfers/', 'icon' => 'bi bi-arrow-left-right'],
            ['label' => 'Returns', 'path' => 'modules/returns/index.php', 'needle' => '/returns/', 'icon' => 'bi bi-arrow-counterclockwise'],
            ['label' => 'Maintenance Log', 'path' => 'modules/maintenance/index.php', 'needle' => '/maintenance/', 'icon' => 'bi bi-wrench-adjustable-circle'],
            ['label' => 'Disposals', 'path' => 'modules/disposals/index.php', 'needle' => '/disposals/', 'icon' => 'bi bi-trash3'],
            ['heading' => 'Registry & Counts'],
            ['label' => 'Asset Registry', 'path' => 'modules/property/index.php', 'needle' => '/property/', 'icon' => 'bi bi-journal-bookmark'],
            ['label' => 'Beginning Balance Encoding', 'path' => 'modules/property/legacy_assets.php', 'needle' => '/property/legacy_assets', 'icon' => 'bi bi-box2-heart'],
