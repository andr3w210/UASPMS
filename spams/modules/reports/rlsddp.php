...
function rlsddp_label(array $row): string
{
...
function rlsddp_person(array $row): string
{
...
if ($isPrint && $record) {
    ...
    <div class="container py-3">
        ...
        <div class="row g-2 mb-3">
            ...
            <div class="col-md-6"><strong>PAR No.:</strong> <?php echo h($record['par_no'] ?? ''); ?></div>
        </div>
...
<div class="report-toolbar"><div><h5 class="report-toolbar-title mb-0">Appendix 75</h5><p class="report-toolbar-copy">Choose a posted equipment disposal record to prepare the official RLSDDP printout.</p></div><div class="report-toolbar-actions"><?php if ($record): ?><a href="<?php echo h(base_url('modules/reports/rlsddp.php?disposal_id=' . $disposalId . '&print=1')); ?>" class="btn btn-primary" target="_blank"><i class="bi bi-printer me-1"></i>Print</a><?php endif; ?></div></div>
