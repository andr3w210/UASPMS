    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center flex-wrap gap-2">
                <div>
                    <h5 class="card-title mb-0"><?php echo $form['id'] > 0 ? 'Edit Mode of Procurement' : 'Add New Mode of Procurement'; ?></h5>
                    <div class="text-muted small">Maintain procurement modes used on purchase orders.</div>
                </div>
                <div class="d-flex gap-2">
                    <button class="btn btn-primary" type="button" data-bs-toggle="collapse" data-bs-target="#formCollapse">
                        <i class="bi bi-plus-circle me-1"></i><?php echo $form['id'] > 0 ? 'Edit Mode' : 'Add New'; ?>
                    </button>
                    <?php if ($form['id'] > 0): ?>
                        <a href="<?php echo base_url('modules/mode_of_procurements/index.php'); ?>" class="btn btn-outline-secondary">Cancel</a>
                    <?php endif; ?>
                </div>
            </div>
            ...
            <div class="collapse <?php echo $form['id'] > 0 ? 'show' : ''; ?>" id="formCollapse">
                <div class="card-body p-4">
                    ...
                    <form method="post">
                        ...
                        <div class="row g-3">
                            <div class="col-md-4">
                                <label class="form-label">Mode Code</label>
                                <input type="text" class="form-control" name="mode_code" value="<?php echo h($form['mode_code']); ?>" placeholder="Enter mode code" required>
                                <div class="form-text">Enter the short mode code manually.</div>
                            </div>

                            <div class="col-md-8">
                                <label class="form-label">Mode Name</label>
                                <input type="text" class="form-control" name="mode_name" value="<?php echo h($form['mode_name']); ?>" required>
                            </div>
                            ...
                            <div class="col-12">
                                <div class="form-check form-switch">
                                    ...
                                    <label class="form-check-label">Active mode of procurement</label>
                                </div>
                            </div>
            ...
            <div class="card-body p-4">
                <div class="d-flex justify-content-between align-items-center flex-wrap gap-2 mb-3">
                    <div>
                        ...
                        <span id="recordCount" class="text-muted small">Showing <?php echo count($procurementModes); ?> of <?php echo count($procurementModes); ?> records</span>
                    </div>
                ...
                <div class="d-flex flex-wrap gap-2 align-items-center mb-3">
                    <input type="search" id="tableSearch" class="form-control form-control-sm" placeholder="Search modes..." style="max-width:300px;">
