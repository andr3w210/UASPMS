...
document.addEventListener('DOMContentLoaded', function () {
    ...
    var options = {
        ...
        emptyMessage: 'No classifications matched your search or status filter.'
    };
