...
if ($db) {
    ...
    ");
    $db->query("ALTER TABLE legacy_assets ADD COLUMN IF NOT EXISTS item_type VARCHAR(30) NOT NULL DEFAULT 'equipment' AFTER property_number");
    $db->query("ALTER TABLE legacy_assets ADD COLUMN IF NOT EXISTS supplier_id INT UNSIGNED NULL AFTER account_code_id");
    $db->query("ALTER TABLE legacy_assets ADD COLUMN IF NOT EXISTS brand_id INT UNSIGNED NULL AFTER supplier_id");
    $db->query("ALTER TABLE legacy_assets ADD COLUMN IF NOT EXISTS model_id INT UNSIGNED NULL AFTER brand_id");
    $db->query("ALTER TABLE legacy_assets ADD COLUMN IF NOT EXISTS quantity INT UNSIGNED NOT NULL DEFAULT 1 AFTER acquisition_date");
    $db->query("ALTER TABLE legacy_assets ADD COLUMN IF NOT EXISTS unit_cost DECIMAL(12,2) NOT NULL DEFAULT 0.00 AFTER quantity");
