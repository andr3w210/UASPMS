    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center flex-wrap gap-2">
                <div>
                    <h5 class="card-title mb-0"><?php echo $form['id'] > 0 ? 'Edit Unit of Measure' : 'Add New Unit of Measure'; ?></h5>
                    <div class="text-muted small">Maintain units used across purchase orders and catalog records.</div>
                </div>
                <div class="d-flex gap-2">
                    <button class="btn btn-primary" type="button" data-bs-toggle="collapse" data-bs-target="#formCollapse">
                        <i class="bi bi-plus-circle me-1"></i><?php echo $form['id'] > 0 ? 'Edit Unit of Measure' : 'Add New'; ?>
                    </button>
                    <?php if ($form['id'] > 0): ?>
                        <a href="<?php echo base_url('modules/unit_of_measures/index.php'); ?>" class="btn btn-outline-secondary">Cancel</a>
                    <?php endif; ?>
                </div>
            </div>
                    ...
                    <form method="post">
                        ...
                        <div class="row g-3">
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control" name="uom_code" value="<?php echo h($form['id'] > 0 ? $form['uom_code'] : $generatedCode); ?>" readonly>
                                <div class="form-text">Generated automatically using UOM-YYYY-0001 format.</div>
                            </div>

                            <div class="col-md-4">
                                <label class="form-label">Unit Name</label>
                                <input type="text" class="form-control" name="uom_name" value="<?php echo h($form['uom_name']); ?>" required>
                            </div>

                            <div class="col-md-4">
                                <label class="form-label">Abbreviation</label>
                                <input type="text" class="form-control" name="abbreviation" value="<?php echo h($form['abbreviation']); ?>" required>
                            </div>
                            ...
                            <div class="col-12">
                                <div class="form-check form-switch">
                                    ...
                                    <label class="form-check-label">Active unit of measure</label>
                                </div>
                            </div>
            ...
            <div class="card-body p-4">
                <div class="d-flex justify-content-between align-items-center flex-wrap gap-2 mb-3">
                    <div>
                        ...
                        <span id="recordCount" class="text-muted small">Showing <?php echo count($units); ?> of <?php echo count($units); ?> records</span>
                    </div>
                ...
                <div class="d-flex flex-wrap gap-2 align-items-center mb-3">
                    <input type="search" id="tableSearch" class="form-control form-control-sm" placeholder="Search units..." style="max-width:300px;">
